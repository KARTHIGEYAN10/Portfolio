...
const ProgrammingLanguage = () => {
    ...
    const languageList=[{name:"Java",img:java},{name:"Python",img:python},{name:"sql",img:sql}]
  ...
  return (
    <div>
        <p className='text-2xl font-semibold mb-5'>PROGRAMMING LANGUAGE KNOWN</p>
            ...
            <div className='p-4 overflow-hidden' style={{width:`${itemVisible*itemWidth}px`}}>
                <div className={`flex gap-5 transition-transform duration-500 ease-in-out`} style={{
                    ...
                    <div className='flex-shrink-0 relative group'>
                        ...
                        <p className='absolute opacity-0 group-hover:opacity-100 transition-opacity tracking-widest duration-300 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2  text-center text-xl font-semibold cursor-pointe text-white cursor-pointer'>{item.name}</p>
                    </div>
                    ))}
                </div>
            </div>
